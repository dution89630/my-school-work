...
Considering the privatization problem, \emph{single lock atomicity} (or \emph{single global lock semantics}) \cite{MBS08} is a widely
...
In a different light, similar to the way using a global lock inherently insure privatization
safety, an STM protocol that uses global shared data structures can often
...
Towards the models focused more towards being easy to understand, there is the \emph{transactional data-race-free}
