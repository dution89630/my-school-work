...
% system.
Nevertheless, this can be anticipated and used
appropriately by the 
programmer,  still resulting  in correctly  functioning  applications.
Ways of how a programmer might consider weak isolation in his code
...
In this thesis we do not accept this solution as we believe making the user have one section
...
to privitize sections memory to a specific process that were previously shared.
...
As shown in \cite{spear07}, prviding privitization safety is not as
...
However, in order to spare the programmer this responsibility,  
...
A blocking implementation of strong isolation presented and performance examined
in \cite{shpeis07} by placing barriers in transactions.
Ways of performing dynamic and static analysis in order to remove certain barriers
while still ensuring strong isolation are proposed in the interest of improving
performance.
...
This  algorithm builds on  the base  of TM
