...
Even so, future research must consider these operations and there are still many questions left unanswered.
...
their semantics is  defined once for all.
As a result in every implementation the effect of performing an enqueue operation
