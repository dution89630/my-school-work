...
%\begin{figure}[ht]
%\centering
%\scalebox{0.30}{\input{virtual-world-consistency.pstex_t}}
...
%\begin{figure}[htb]
%\centering{
%  \scalebox{0.45}{\input{fig-opacity-impossibility.pstex_t}}
...
%\begin{figure}[htb]
%\centering{
%  \scalebox{0.45}{\input{fig-implementing-register-X.pstex_t}}
...
\paragraph{Proof of the algorithm for VWC and read invisibility}
Due to space limitations, the proof is not included here. It can be found in 
Section \ref{sec:algorithm-V1-proof} of the Appendix and in \cite{CIR10}.


\paragraph{Improving the  base protocol described in Figure 
\ref{fig:ttc-protocol}}
The base protocol 
  presented previously can be improved on the following three points:
...
Due to space limitations, these improvements are not included here. 
They can be found in Section \ref{sec:improving-base-protocol}
of the Appendix and in \cite{CIR10}.
...
%\begin{figure}[ht]
%\centering
%\scalebox{0.35}{\input{fig-intervals.pstex_t}}
...
%--------------------------------------------------------------------------
\vspace{-0.3cm}
\paragraph{Proof of the probabilistic permissiveness property}
Due to space limitations, the proof is not included here. It can be found in 
Section \ref{sec:proof-proba} of the Appendix and in \cite{CIR10}.
...
%===================================================
\section{Proof of the probabilistic permissiveness property}
