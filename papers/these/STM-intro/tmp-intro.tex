...
a persons thought process happens sequentially
...
\anote{Citation?} the transaction performs its write
...
In an implementation that uses \emph{write buffering} \cite{}
\anote{Citation?}
