...
\line{A04} \>\>\> $\mathit{value} \gets \mathit{tmp.last}$ \\
\line{A07} \>\> {\bf else} $\mathit{value} \gets \mathit{tmp.value}$ {\bf end if} \\
\line{A07} \> {\bf else} $\mathit{value} \gets \mathit{tmp.value}$ {\bf end if} \\
\line{A10} \> $\mathit{time} \gets {\sf max}(\mathit{time}, \sf{min}(\mathit{tmp.time, GCV}))$ \\
\line{A13} \> ${\sf return}$ ($\mathit{value}$) \\
{\bf end operation}. \\
\\
...
\line{C16} \>\>\> {\bf then} ${\sf validate\_by\_value}()$ {\bf end if}; \\
\line{C23} \>\> $\mathit{value} \gets \mathit{tmp.value}$ \\

\line{C05} \> {\bf else} \\
\line{C05} \>\> {\bf if} ($(\mathit{status} \gets \mathit{tmp.status}) \neq$ COMMITTED $)$ {\bf then} \\
\line{C06} \>\>\> {\bf if} $\mathit{status} =$ LIVE {\bf then} ${\sf abort}()$  {\bf else} $\mathit{value} \gets \mathit{tmp.last}$ {\bf end if} \\
...
\line{C29} \> ${\sf return}$ ($\mathit{value}$) \\
{\bf end operation}. \\
\\
...
\line{C11} \>\> {\bf else} $\mathit{item.last} \gets \mathit{tmp.value}$ {\bf end if}; \\
...
\line{DA12} \> ${\sf validate\_by\_value}()$;  \\
...
\line{H05} \>\>\> $\mathit{value} \gets \mathit{tmp.last}$ \\
\line{H06} \>\> {\bf else} $\mathit{value} \gets \mathit{tmp.value}$ {\bf end if}; \\
...
\line{H21} \> $\mathit{status} \gets $ ABORTED; \\
