...
In fact virtually all published STM protocols abort transactions that could
...
Though the previous section shows that it is possible to have an STM protocol with read invisibility
that is virtual world consistent and permissive, but it does not show that it is realistic to implement.
