...
By following our goal for STM defined in \ref{def:stm-def} and using our defnintion for a transaction \ref{def:trans-def},
...
$$atomic \{ \dots \} $$
The is because follwoing Definition \ref{def:trans-def}, a transaction always executes as an atomic block
