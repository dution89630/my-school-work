...
Section \ref{sec:model-and-conditions} of the first chapter described the general model of transactions that will
be used in these definitions and throughout this chapter.
Before getting into the formal definitions, here first we define some additional properties
