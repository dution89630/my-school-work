...
This  distinction  of   guarantees  was  originally  made  in
...
While the concept of the memory  transaction includes the possibility of abort,
the concept of the non-transactional read/write operation does not.  This means that a
...
For this reason we believe that an STM protocol just implementing srong
isolation is not enough, the progress of non-transactional operations
