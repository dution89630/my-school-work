...
Ideally, an STM system should be  such that, from the programmer's point of
...
\cite{F11}.}:  the programmer does  not need  to be  aware of   the  way the
underlying STM system works 
...
shows that the  number of times a transaction can  be executed before being
committed is bounded. 
...
H\_UC could be used for STM programs   by
